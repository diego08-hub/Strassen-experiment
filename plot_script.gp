...
set output 'plots/grafico_potencia2.png'
...
plot 'data/resultados.csv' using 1:2 with linespoints ls 1 title 'Estándar', \
     'data/resultados.csv' using 1:3 with linespoints ls 2 title 'Strassen'
