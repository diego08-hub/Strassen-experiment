...
set output 'plots/grafico_bc08.png'
...
plot 'data/resultados_bc16.csv' using 1:2 with linespoints ls 1 title 'Estándar', \
     'data/resultados_bc16.csv' using 1:3 with linespoints ls 2 title 'Strassen'
